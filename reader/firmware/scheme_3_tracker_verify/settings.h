...
const char banner[] =
    ...
    "|               If content is encoded using tracker protocol, it checks if it followed |\n"
    "|               one of the stored paths.                                               |\n"
    "----------------------------------------------------------------------------------------\n";
// same but smaller
const char screenBanner[] = "Tracker Verify";