...
const char banner[] = 
    ...
    "|               and updates according to the RF-Chain scheme. We made modifications    |\n"
    "|               so that RF-Chain doesn't require reader-reader communication.          |\n"
    "|               Content is sent to screen, serial, or mqtt (whatever is available).    |\n"
    "----------------------------------------------------------------------------------------\n";
// same but smaller
const char screenBanner[] = "RF-Chain";